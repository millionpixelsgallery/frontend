import { forwardRef, memo, MouseEvent as ReactMouseEvent, useCallback, useState } from 'react'
...
const Select = forwardRef<any, SelectProps>(
  ({ x, y, width, height, scale = 1, onResize, onMove, onMouseUp }: SelectProps, ref) => {
